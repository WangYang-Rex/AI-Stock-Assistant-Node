...
const stock_module_1 = require("../market/stock/stock.module");
const trends_module_1 = require("../market/trends/trends.module");
const close_auction_module_1 = require("../strategies/close-auction/close-auction.module");
let SchedulerModule = class SchedulerModule {
};
exports.SchedulerModule = SchedulerModule;
exports.SchedulerModule = SchedulerModule = __decorate([
    (0, common_1.Module)({
        imports: [stock_module_1.StockModule, trends_module_1.TrendsModule, close_auction_module_1.CloseAuctionModule],
